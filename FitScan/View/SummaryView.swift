...
//  FitScan
//
//  Created by Akhil on 2024-02-09.
//
                ...
                ZStack{
                    VStack(alignment: .center){
                        ...
                        NavigationLink(destination: DetailChartView(nutritionType: "Calories", nutriToday: todaysNutrition.calories, nutriUnit: "Cal", rawSelectedHour: $selectedHour)) {
                            nutriDisplayView(name: "Calories", unit: "Cal", nutriToday: todaysNutrition.calories, nutriConst: caloriesGoal, bgColor: colorFromString(currentTheme), fgColors: [colorFromString(currentTheme), colorFromString(currentTheme)])
                        }
                        Spacer()
                        NavigationLink(destination: DetailChartView(nutritionType: "Protein", nutriToday: todaysNutrition.protein, nutriUnit: "g", rawSelectedHour: $selectedHour)) {
                            nutriDisplayView(name: "Protein",  unit: "g",nutriToday: todaysNutrition.protein, nutriConst: proteinGoal, bgColor: colorFromString(currentTheme), fgColors: [colorFromString(currentTheme), colorFromString(currentTheme)])
                        }
                        Spacer()
                        NavigationLink(destination: DetailChartView(nutritionType: "Carbohydrate", nutriToday: todaysNutrition.carbs, nutriUnit: "g", rawSelectedHour: $selectedHour)) {
                            nutriDisplayView(name: "Carbohydrate",  unit: "g", nutriToday: todaysNutrition.carbs, nutriConst: carbohydrateGoal, bgColor: colorFromString(currentTheme), fgColors: [colorFromString(currentTheme), colorFromString(currentTheme)])
                        }
                        Spacer()
                        NavigationLink(destination: DetailChartView(nutritionType: "Fat", nutriToday: todaysNutrition.fat, nutriUnit: "g", rawSelectedHour: $selectedHour)) {
                            nutriDisplayView(name: "Fat",  unit: "g", nutriToday: todaysNutrition.fat, nutriConst: fatGoal, bgColor:colorFromString(currentTheme), fgColors: [colorFromString(currentTheme), colorFromString(currentTheme)])
                        }
                        Spacer()
                        Spacer()
